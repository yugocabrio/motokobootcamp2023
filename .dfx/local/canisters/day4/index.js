...
import { idlFactory } from './day4.did.js';
export { idlFactory } from './day4.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAY4_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./day4.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the day4 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./day4.did.js")._SERVICE>}
 */
export const day4 = createActor(canisterId);
