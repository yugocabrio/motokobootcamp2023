...
import { idlFactory } from './practice_memo.did.js';
export { idlFactory } from './practice_memo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PRACTICE_MEMO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./practice_memo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the practice_memo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./practice_memo.did.js")._SERVICE>}
 */
export const practice_memo = createActor(canisterId);
